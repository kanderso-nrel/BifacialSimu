...
'endHour' : (2021, 3, 1, 0),  # Only for hourly simulation, yy, mm, dd, hh
'utcOffset': 1,
...
'spectralAlbedo' : False, # Option to calculate a spectral Albedo 
'fixAlbedo' : False, #reaktion auf Error VF braucht offenbar diesen Wert in line 658 (radiation handler)
'variableAlbedo': False, #reaktion auf Error VF braucht offenbar diesen Wert in line 663 (radiation handler)
